...
@{
    ...
    PrivateData = @{
        ...
        PSData = @{
            ...
            ProjectUri = 'https://github.com/webmd-health-services/Carbon.ScheduledTasks'
            ...
            ReleaseNotes = 'https://github.com/webmdh-health-services/Carbon.ScheduledTasks/blob/main/CHANGELOG.md'
